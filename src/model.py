...
# Model parameters - how models were trained. Images we pass through need to be processed in the same way training images were processed
in_width = 300
in_height = 300
mean = [104, 117, 123]
conf_threshold = 0.7
...
while cv2.waitKey(1) != 27:
    ...
    # preprocessing on image frame, 1.0 is the scale mentioned in yml file. swaRB is false because OpenCV and Caffe use same convention for BGR channels
    # crop your input image to be correct size or resize it. Crop false so resizing occurs
    ...
    for i in range(detections.shape[2]):
        ...
        if confidence>conf_threshold:
            ...
            cv2.rectangle(frame, (x_left_bottom, y_left_bottom), (x_right_top, y_right_top), (0,255,0), 10)
